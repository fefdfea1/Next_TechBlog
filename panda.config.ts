    ...
    extend: {
      tokens: {
        colors: {
          ...
          InputShadow: { value: "rgba(0,0,0,0.2)" },
          HoverModalBg: { value: "#ffffff" },
          ActiveColor: { value: "#F65665" },
          ReferenceBg: { value: "#fff" },
          ReferenceUlBg: { value: "#fff" },
          ReferenceListColor: { value: "#999" },
        },
      },
    },
  },
